...
import ImageGrid from './components/PictureWall'
...
const LayoutOver =()=>{
  return(
    <Card>
    <div className="dark:text-gray-200 text-center text-2xl m-4 w-full hover:scale-110 transition-all duration-150">真的是最后一步了</div>
    <UniqueCard
      ...
      <div
        ...
        <main
          ...
          <div
            ...
            <div
              className={`${className || ''} w-full ${fullWidth ? '' : (shrink ? 'max-w-4xl' : 'max-w-6xl')} h-full overflow-hidden`}>
              <Transition
                show={!onLoading}
                appear={true}
                enter='transition ease-in-out duration-700 transform order-first'
