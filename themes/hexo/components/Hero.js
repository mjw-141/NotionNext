...
const Hero = props => {
  ...
  return (
    <header
      ...
      <div className='text-white absolute bottom-0 flex flex-col h-full items-left justify-center w-full ml-40'>
        {/* 站点标题 */}
        <div className='font-black text-4xl md:text-5xl shadow-text mt-40'>
          {siteInfo?.title || siteConfig('TITLE')}
        </div>
        {/* 站点欢迎语 */}
        <div className='mt-2 h-12 items-center text-center font-medium shadow-text text-lg ml-40'>
          <span id='typed' />
        </div>
